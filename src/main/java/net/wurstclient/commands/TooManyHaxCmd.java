...
public final class TooManyHaxCmd extends Command
{
	...
	{
		WURST.getHax().getTooManyHaxHack().blockAll();
	...
	{
		WURST.getHax().getTooManyHaxHack().unblockAll();
	...
	private void loadProfile(String[] args) throws CmdException
	{
		...
		try
		{
			WURST.getHax().getTooManyHaxHack().loadProfile(name);
	...
	private void saveProfile(String[] args) throws CmdException
	{
		...
		try
		{
			WURST.getHax().getTooManyHaxHack().saveProfile(name);
